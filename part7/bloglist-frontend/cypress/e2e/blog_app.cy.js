describe("Blog app", function () {
  ...
  describe("Login", function () {
    it("succeeds with correct credentials", function () {
      cy.get("#username").type("peterang", { force: true });
      cy.get("#password").type("iampeterang", { force: true });
  ...
  describe("when logged in", function () {
    ...
    describe("after new blog is created", function () {
      ...
      it("can delete a blog", function () {
        ...
        cy.get("html").should(
          "not.contain",
          "I am Number Four Geronimo Stilton",
        );
      });
      ...
      it("only creator of blog can see the delete button", function () {
        ...
        cy.get("#username").type("emersonang", { force: true });
        cy.get("#password").type("iamemersonang", { force: true });
        cy.get("#login-button").click({ force: true });
      ...
      it.only("ordered based on descending number of likes", function () {
        ...
        cy.contains("I am Number Three Thea Stilton")
          .find(".view")
          .click({ force: true });
        cy.contains("I am Number Three Thea Stilton")
          .find(".like")
        ...
        cy.get(".blogs")
          .eq(0)
          .should("contain", "I am Number Three Thea Stilton");
        cy.get(".blogs")
          .eq(0)
          .should("contain", "I am Number Four Geronimo Stilton");
      });
    });
  });
});
